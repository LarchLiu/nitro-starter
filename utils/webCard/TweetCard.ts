export function TweetCard(avator: string, name: string, screenName: string, content: string[], pubTime: string, lang?: string) {
  ...
  return `<div class="h-full w-full flex flex-col justify-between bg-white p-60px text-60px">
    <div class="flex flex-col">
      <div class="flex items-center">
        ...
        <div class="ml-20px flex flex-col text-40px">
          ...
          <span lang="${language}">@${screenName}</span>
        </div>
      </div>
